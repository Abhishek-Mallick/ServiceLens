...
export interface ButtonProps
  ...
  asChild?: boolean;
  // Compatibility with base-ui shadcn: `render={<X />}` maps to `asChild + Slot(<X />)`.
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, render, nativeButton, children, ...props }, ref) => {
    ...
    if (render) {
      ...
      const childContent = renderProps.children ?? children;
      if (childContent !== undefined) merged.children = childContent;
