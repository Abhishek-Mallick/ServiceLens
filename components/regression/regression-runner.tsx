      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2 overflow-hidden">
          ...
          <CardContent className="pt-0">
            <div className="h-[440px] rounded-md border border-border/50 overflow-hidden">
      ...
      <Card>
        ...
        <CardContent className="pt-0 divide-y divide-border/50">
          ...
          {runs.map((r) => {
            ...
            return (
              <Link key={r.id} href={`/architectures/${architectureId}/regression/${r.id}`} className="flex items-center justify-between gap-3 py-3 hover:bg-muted/40 -mx-4 px-4 rounded">
                ...
                <div className="flex items-center gap-4 text-xs">
                  <span className="text-emerald-500">{r.passedSteps} passed</span>
